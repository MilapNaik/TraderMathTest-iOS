...
open class JLToastWindow: UIWindow {
    
    open static let sharedWindow = JLToastWindow(frame: UIScreen.main.bounds)
    ...
    var shouldRotateManually: Bool {
        ...
        let requiresFullScreen = (info?["UIRequiresFullScreen"] as AnyObject).boolValue == true
